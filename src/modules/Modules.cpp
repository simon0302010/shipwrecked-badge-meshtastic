...
#endif
#if !MESHTASTIC_EXCLUDE_PROXIMITYALERT
#include "modules/ProximityAlertModule.h"
#endif
#if !MESHTASTIC_EXCLUDE_MESSAGEINBOX
#include "modules/MessageInboxModule.h"
#endif
...
#endif
#if HAS_SCREEN && !MESHTASTIC_EXCLUDE_PROXIMITYALERT
    if (config.display.displaymode != meshtastic_Config_DisplayConfig_DisplayMode_COLOR) {
        proximityAlertModule = new ProximityAlertModule();
    }
#endif
#if HAS_SCREEN && !MESHTASTIC_EXCLUDE_MESSAGEINBOX
    if (config.display.displaymode != meshtastic_Config_DisplayConfig_DisplayMode_COLOR) {
        messageInboxModule = new MessageInboxModule();
    }
#endif
#if ARCH_PORTDUINO
