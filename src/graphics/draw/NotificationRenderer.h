...
class NotificationRenderer
{
  public:
    ...
    // Proximity alert slot (drawn as an independent overlay, does not conflict with text_input or text_banner).
    static char proximityAlertMessage[256];
    static uint32_t proximityAlertUntil; // 0 = inactive
    ...
    static void drawProximityAlertOverlay(OLEDDisplay *display, OLEDDisplayUiState *state);
